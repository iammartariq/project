...
interface CanceledModalProps {
    isCanceledModalOpen: boolean;
    setIsCanceledModalOpen: (open: boolean) => void;
}

const CanceledModal: React.FC<CanceledModalProps> = ({ isCanceledModalOpen, setIsCanceledModalOpen }) => {
    return (
        <div>
            {" "}
            <Dialog
