...
const ConnectAudience: React.FC = () => {
   return (
      <div className="order-2 lg:order-1 flex flex-col gap-[23px] 2xl:gap-[43px] justify-center items-center pb-[54px] sm:pb-0 sm:py-[50px] 2xl:py-[107px] lg:w-1/2 2xl:w-auto">
