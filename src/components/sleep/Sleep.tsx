...
const Sleep = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      await fetchTracks('RenewMe', 'Bedtime Stories', currentPage, limit).then((result)=>{
  ...
  return (
    <ProtectedRoute>
      <div>
        <h2 className="text-white sm:text-[40px] text-[24px] font-semibold leading-[48px]">Sleep</h2>
