...
const StayMotivated = () => {
   return (
      <div>
         <div className="md:py-[80px] py-[0_40px] relative">
            <div className="max-w-[1120px] mx-auto">
               ...
               <div className="flex md:flex-row flex-col md:items-start items-center xl:justify-between justify-center md:gap-4 relative z-[1]">
                  <Image
                     ...
                     src={"/assets/images/landing/s6-phone-2.png"}
                     width={326}
                     height={665}
                     alt="s1-phone-2"
                  />
                  <div className="flex flex-col items-center">
                     <Image
                        ...
                        src={"/assets/images/landing/s6-phone-1.png"}
                        width={326}
                        height={665}
                        alt="s3-phone-1"
                     />
                     <div className="flex flex-col items-center w-[270px] md:w-[200px] lg:mt-[90px] mt-[40px] lg:w-[250px] xl:w-[314px]">
                        <Image
                           src={"/assets/images/landing/svg/s6-info.svg"}
                           alt="s5-info"
                           width={50}
                           height={50}
                        />
                        ...
                        <p className="text-justify !font-['Gilroy'] text-sm font-[400] text-[#3A3A3B] md:text-base lg:text-[20px] mt-2">
                           Ignite your motivation with daily doses of pep talks,
                           affirmations, and insights inspiring you to attain a
                           balanced lifestyle.
                        </p>
                     </div>
                  </div>
                  <Image
                     ...
                     src={"/assets/images/landing/s6-phone-3.png"}
                     width={326}
                     height={665}
                     alt="s3-phone-3"
                  />
